  ...
  data() {
    return {
      ...
      columnConfig: [
        ...
        { prop: "w_order_num", label: "订单号", minWidth: "100", sortable: true },
        { prop: "w_username", label: "用户名", minWidth: "100", sortable: true },
        ...
        { prop: "w_import_date", label: "导入日期", minWidth: "100", sortable: true },
        { prop: "w_img_url", label: "地址", minWidth: "100", sortable: true },
        { prop: "w_update_status", label: "订单状态", minWidth: "100", sortable: true, render: function(row, column, cellValue) {
        ...
        { prop: "w_trackingmore_request", label: "物流状态", minWidth: "100", sortable: true },
        { prop: "w_paging_request", label: "分页请求", minWidth: "100", sortable: true },
        { prop: "w_wl_status", label: "状态", minWidth: "100", sortable: true },

        { prop: "w_modify_date", label: "修改日期", minWidth: "100", sortable: true },
        { prop: "w_isShow", label: "显示订单", minWidth: "100", sortable: true, render: function(row, column, cellValue) {
            if (row.status === 0) {
        ...
        { prop: "w_isShow_date", label: "是否显示日期", minWidth: "100", sortable: true },
        { prop: "w_delete_date", label: "删除日期", minWidth: "100", sortable: true },
        { prop: "w_praise", label: "是否点赞过",
         minWidth: "100", sortable: true },
        { prop: "w_praise_date", label: "点赞日期", minWidth: "100", align: "right", headerAlign: "left", sortable: true }
      ]
    };
  },
  mounted() {
